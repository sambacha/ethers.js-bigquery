...
var parsedLog = interface_instance.parseLog({
  ...
  data:
    "0x000000000000000000000000000000000000000000000000002386f26fc10000000000000000000000000000000000000000000000000000000000005a7c42f9",
});
...
for (var k in parsedValues) {
  if (parsedValues.hasOwnProperty(k)) {
    result[k] = ethers.utils.Interface.isIndexed(parsedValues[k])
      ? parsedValues[k].hash
      : parsedValues[k];
  }
}
